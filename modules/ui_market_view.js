...
UIMarketView.prototype.show = function() {
    ...
    ui.layout(
        ...
        '    <text text="任务市场" textSize="22sp" textColor="' + C.textPrimary + '" textStyle="bold" layout_weight="1"/>' +
        ...
        '        </vertical>' +
        '        <button id="btn_import" text="↓ 导入" bg="' + C.primary + '" textColor="white" textSize="13sp" cornerRadius="10" h="36" w="68" marginLeft="8" textStyle="bold"/>' +
        '      </horizontal>' +
...
UIMarketView.prototype.showDetail = function(marketTask) {
    ...
    ui.layout(
        ...
        '      </vertical>' +
        '      <!-- 导入按钮 -->' +
        '      <button id="btn_import_task" text="↓ 导入任务" bg="' + C.primary + '" textColor="white" textSize="15sp" cornerRadius="12" h="52" marginTop="24" textStyle="bold"/>' +
        '    </vertical>' +
        '  </scroll>' +
        '</vertical>'
    );
