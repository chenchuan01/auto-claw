...
UIScriptEditor.prototype.show = function(taskId) {
    ...
    ui.layout(
        ...
        '    <text text="任务详情与编辑" textSize="18sp" textColor="#FFFFFF" textStyle="bold" layout_weight="1"/>' +
        '    <text id="btn_save" text="💾" textSize="20sp" textColor="#FFFFFF" padding="8"/>' +
        '  </horizontal>' +
        '  <scroll bg="' + C.bg + '">' +
        '    <vertical padding="16">' +
        ...
        '          <text text="任务脚本" textSize="14sp" textColor="' + C.textSecondary + '" textStyle="bold" layout_weight="1"/>' +
        '          <text id="btn_reset" text="重置" textSize="12sp" textColor="' + C.primary + '" padding="4 8"/>' +
        '        </horizontal>' +
        '        <input id="script_input" hint="请输入任务脚本代码..." textSize="12sp" textColor="' + C.textPrimary + '" bg="' + C.surface + '" padding="12" cornerRadius="8" minLines="15" gravity="top" singleLine="false"/>' +
        '      </vertical>' +
        '      <vertical bg="' + C.card + '" cornerRadius="14" padding="20" marginTop="12">' +
